...
export const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    description:
      'Project Manager ; Logistics team spends up to 50% of their time on reporting and information sharing, waiting on this impacts decision making with other groups ; Get up-to-date information to make faster decisions, reducing air freight and potential production downtime',
    date: new Date('2011-10-05T14:48:00.000Z'),
    images: [{ alt: 'image', src: '/assets/images/aws.png' }],
  },
  {
    title: 'AI-enabled Procurement',
    subtitle: 'Spend categorisation, AI cleansheet',
    description:
      'Procurement Manager ; Spend data is usually fragmented and unstructured, which makes it difficult to properly and accurately categorise spend ; Converts large data sets into easy-to-read dashboards with actionable insights to drive data-driven decision making',
  ...
  // },
  {
    ...
    description:
      'Production Manager ; Varying business focus (e.g. target fulfilment rate, cost cutting, maximise profit) result in difficulty for planner to optimise resource allocation ; Actively optimise production planning based on change in demand and allocate the right capacity for each equipment',
    date: new Date('2013-10-05T14:48:00.000Z'),
    images: [{ alt: 'image', src: '/assets/images/uc-capacity-planning.png' }],
  },
  {
    ...
    description:
      'Maintenance Manager ; Reactive maintenance often leads to unplanned downtime and repair cost ; Proactive maintenance reduces equipment downtime and repair cost, allowing planned maintenance ahead of time',
  ...
  },
  {
    ...
    description:
      'Customer Service Officer ; Customer service in logistics departments often rely on time-consuming manual labour to process enquiries and requests ; Fully automated customer service for final product delivery related enquiry',
